                    ...
                    <section class="content">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <f:form class="form-horizontal form-label-left" action="insertColor.htm" method="GET" commandName="newColor" enctype="multipart/form-data"  onsubmit="return validate()">
