                    ...
                    <section class="content">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <f:form class="form-horizontal form-label-left" action="insertUser.htm" method="GET" commandName="newUser" enctype="multipart/form-data"  onsubmit="return validate()">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <f:input type="password" id="password"  class="form-control col-md-7 col-xs-12" path="password" /> 
                                                </div>
                                            </div>
                                            <div class="form-group">
