                ...
                <div class="content-wrapper">
                    ...
                    <section class="content-header">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Size Detail</li>
                        </ol>
                    </section>
                    <!-- Main content -->
                    <section class="content">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <f:form class="form-horizontal form-label-left" commandName="size">
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Size ID</label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <f:input type="text" id="sizeId" class="form-control col-md-7 col-xs-12" path="sizeId" readonly="true"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Size Name</label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <f:input type="text" id="sizeName" class="form-control col-md-7 col-xs-12" path="sizeName" readonly="true" />
                                                </div>
                                            </div>
                                            <div class="form-group">
