...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../jsp/admin/css/bootstrap.min.css" />
        <link rel="stylesheet" href="../jsp/admin/css/font-awesome.min.css" />
        <!-- text fonts -->
        <link rel="stylesheet" href="../jsp/admin/fonts.googleapis.com.css" />
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
        <link href="../jsp/admin/css/sweetalert.css" rel="stylesheet" type="text/css"/>
        <!-- ace styles -->
        <link rel="stylesheet" href="../jsp/admin/css/ace.min.css" />
    ...
    <body class="login-layout">
        ...
        <!--[if !IE]> -->
        <script src="../jsp/admin/js/jquery.2.1.4.min.js"></script>
...
<![endif]-->
        ...
        <script type="text/javascript">
            window.jQuery || document.write("<script src='../jsp/admin/js/jquery.min.js'>" + "<" + "/script>");
        </script>
...
<![endif]-->
        <script type="text/javascript">
            if ('ontouchstart' in document.documentElement)
                document.write("<script src='../jsp/admin/js/jquery.mobile.custom.min.js'>" + "<" + "/script>");
        </script>
        <script src="../jsp/admin/js/sweetalert.min.js" type="text/javascript"></script>
