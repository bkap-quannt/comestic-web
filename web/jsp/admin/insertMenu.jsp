                    ...
                    <section class="content">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <f:form class="form-horizontal form-label-left" action="insertMenu.htm" method="GET" commandName="newMenu" enctype="multipart/form-data"  onsubmit="return validate()">
