                    ...
                    <section class="content">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <f:form class="form-horizontal form-label-left" commandName="menu">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <f:input type="text" id="menuName" class="form-control col-md-7 col-xs-12" path="menuName" readonly="true" />
                                                </div>
                                            </div>
                                            <div class="form-group">
