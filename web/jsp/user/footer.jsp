        ...
        <div class="container">
          <div class="footer-widgets top-bottom-dividers pb-mdm-20">
            <div class="row">
              ...
              <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="widget footer-links list-no-dividers">
                  <h5 class="widget-title uppercase">Shops</h5>
                  <ul>
                    <li><a href="#">Man</a></li>
              ...
              <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="widget newsletter-widget">
                  <h5 class="widget-title uppercase">Stay Tuned</h5>
                  ...
                  <form class="relative newsletter-form mt-30">
                    ...
                    <input type="submit" class="btn btn-md btn-dark newsletter-submit" value="Subscribe">
                  </form>
                </div>
              </div>             
